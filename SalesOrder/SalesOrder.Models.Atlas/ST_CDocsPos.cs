namespace SalesOrder.Models.Atlas
{
    ...
    public partial class ST_CDocsPos
    {
        [Key]
        [Column(Order = 0)]
        ...
        public double? PricePharma { get; set; }
        ...
        public int? ZaBranchID { get; set; }

        public int? ZaDocID { get; set; }

        public int? ZaLine { get; set; }

        public int? ZaLinePos { get; set; }
