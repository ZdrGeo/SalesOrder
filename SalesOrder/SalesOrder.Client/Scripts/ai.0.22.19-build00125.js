...
(function (Microsoft) {
    ...
    (function (ApplicationInsights) {
        (function (LoggingSeverity) {
            LoggingSeverityLoggingSeverity"CRITICAL"] = 0] = "CRITICAL";
            LoggingSeverityLoggingSeverity"WARNING"] = 1] = "WARNING";
        ...
        (function (_InternalMessageId) {
            _InternalMessageId_InternalMessageId"NONUSRACT_BrowserDoesNotSupportLocalStorage"] = 0] = "NONUSRACT_BrowserDoesNotSupportLocalStorage";
            _InternalMessageId_InternalMessageId"NONUSRACT_BrowserCannotReadLocalStorage"] = 1] = "NONUSRACT_BrowserCannotReadLocalStorage";
            _InternalMessageId_InternalMessageId"NONUSRACT_BrowserCannotReadSessionStorage"] = 2] = "NONUSRACT_BrowserCannotReadSessionStorage";
            _InternalMessageId_InternalMessageId"NONUSRACT_BrowserCannotWriteLocalStorage"] = 3] = "NONUSRACT_BrowserCannotWriteLocalStorage";
            _InternalMessageId_InternalMessageId"NONUSRACT_BrowserCannotWriteSessionStorage"] = 4] = "NONUSRACT_BrowserCannotWriteSessionStorage";
            _InternalMessageId_InternalMessageId"NONUSRACT_BrowserFailedRemovalFromLocalStorage"] = 5] = "NONUSRACT_BrowserFailedRemovalFromLocalStorage";
            _InternalMessageId_InternalMessageId"NONUSRACT_BrowserFailedRemovalFromSessionStorage"] = 6] = "NONUSRACT_BrowserFailedRemovalFromSessionStorage";
            _InternalMessageId_InternalMessageId"NONUSRACT_CannotSendEmptyTelemetry"] = 7] = "NONUSRACT_CannotSendEmptyTelemetry";
            _InternalMessageId_InternalMessageId"NONUSRACT_ClientPerformanceMathError"] = 8] = "NONUSRACT_ClientPerformanceMathError";
            _InternalMessageId_InternalMessageId"NONUSRACT_ErrorParsingAISessionCookie"] = 9] = "NONUSRACT_ErrorParsingAISessionCookie";
            _InternalMessageId_InternalMessageId"NONUSRACT_ErrorPVCalc"] = 10] = "NONUSRACT_ErrorPVCalc";
            _InternalMessageId_InternalMessageId"NONUSRACT_ExceptionWhileLoggingError"] = 11] = "NONUSRACT_ExceptionWhileLoggingError";
            _InternalMessageId_InternalMessageId"NONUSRACT_FailedAddingTelemetryToBuffer"] = 12] = "NONUSRACT_FailedAddingTelemetryToBuffer";
            _InternalMessageId_InternalMessageId"NONUSRACT_FailedMonitorAjaxAbort"] = 13] = "NONUSRACT_FailedMonitorAjaxAbort";
            _InternalMessageId_InternalMessageId"NONUSRACT_FailedMonitorAjaxDur"] = 14] = "NONUSRACT_FailedMonitorAjaxDur";
            _InternalMessageId_InternalMessageId"NONUSRACT_FailedMonitorAjaxOpen"] = 15] = "NONUSRACT_FailedMonitorAjaxOpen";
            _InternalMessageId_InternalMessageId"NONUSRACT_FailedMonitorAjaxRSC"] = 16] = "NONUSRACT_FailedMonitorAjaxRSC";
            _InternalMessageId_InternalMessageId"NONUSRACT_FailedMonitorAjaxSend"] = 17] = "NONUSRACT_FailedMonitorAjaxSend";
            _InternalMessageId_InternalMessageId"NONUSRACT_FailedToAddHandlerForOnBeforeUnload"] = 18] = "NONUSRACT_FailedToAddHandlerForOnBeforeUnload";
            _InternalMessageId_InternalMessageId"NONUSRACT_FailedToSendQueuedTelemetry"] = 19] = "NONUSRACT_FailedToSendQueuedTelemetry";
            _InternalMessageId_InternalMessageId"NONUSRACT_FailedToReportDataLoss"] = 20] = "NONUSRACT_FailedToReportDataLoss";
            _InternalMessageId_InternalMessageId"NONUSRACT_FlushFailed"] = 21] = "NONUSRACT_FlushFailed";
            _InternalMessageId_InternalMessageId"NONUSRACT_MessageLimitPerPVExceeded"] = 22] = "NONUSRACT_MessageLimitPerPVExceeded";
            _InternalMessageId_InternalMessageId"NONUSRACT_MissingRequiredFieldSpecification"] = 23] = "NONUSRACT_MissingRequiredFieldSpecification";
            _InternalMessageId_InternalMessageId"NONUSRACT_NavigationTimingNotSupported"] = 24] = "NONUSRACT_NavigationTimingNotSupported";
            _InternalMessageId_InternalMessageId"NONUSRACT_OnError"] = 25] = "NONUSRACT_OnError";
            _InternalMessageId_InternalMessageId"NONUSRACT_SessionRenewalDateIsZero"] = 26] = "NONUSRACT_SessionRenewalDateIsZero";
            _InternalMessageId_InternalMessageId"NONUSRACT_SenderNotInitialized"] = 27] = "NONUSRACT_SenderNotInitialized";
            _InternalMessageId_InternalMessageId"NONUSRACT_StartTrackEventFailed"] = 28] = "NONUSRACT_StartTrackEventFailed";
            _InternalMessageId_InternalMessageId"NONUSRACT_StopTrackEventFailed"] = 29] = "NONUSRACT_StopTrackEventFailed";
            _InternalMessageId_InternalMessageId"NONUSRACT_StartTrackFailed"] = 30] = "NONUSRACT_StartTrackFailed";
            _InternalMessageId_InternalMessageId"NONUSRACT_StopTrackFailed"] = 31] = "NONUSRACT_StopTrackFailed";
            _InternalMessageId_InternalMessageId"NONUSRACT_TelemetrySampledAndNotSent"] = 32] = "NONUSRACT_TelemetrySampledAndNotSent";
            _InternalMessageId_InternalMessageId"NONUSRACT_TrackEventFailed"] = 33] = "NONUSRACT_TrackEventFailed";
            _InternalMessageId_InternalMessageId"NONUSRACT_TrackExceptionFailed"] = 34] = "NONUSRACT_TrackExceptionFailed";
            _InternalMessageId_InternalMessageId"NONUSRACT_TrackMetricFailed"] = 35] = "NONUSRACT_TrackMetricFailed";
            _InternalMessageId_InternalMessageId"NONUSRACT_TrackPVFailed"] = 36] = "NONUSRACT_TrackPVFailed";
            _InternalMessageId_InternalMessageId"NONUSRACT_TrackPVFailedCalc"] = 37] = "NONUSRACT_TrackPVFailedCalc";
            _InternalMessageId_InternalMessageId"NONUSRACT_TrackTraceFailed"] = 38] = "NONUSRACT_TrackTraceFailed";
            _InternalMessageId_InternalMessageId"NONUSRACT_TransmissionFailed"] = 39] = "NONUSRACT_TransmissionFailed";
            _InternalMessageId_InternalMessageId"NONUSRACT_FailToSetStorageBuffer"] = 40] = "NONUSRACT_FailToSetStorageBuffer";
            _InternalMessageId_InternalMessageId"NONUSRACT_FailToRestoreStorageBuffer"] = 41] = "NONUSRACT_FailToRestoreStorageBuffer";
            _InternalMessageId_InternalMessageId"USRACT_CannotSerializeObject"] = 42] = "USRACT_CannotSerializeObject";
            _InternalMessageId_InternalMessageId"USRACT_CannotSerializeObjectNonSerializable"] = 43] = "USRACT_CannotSerializeObjectNonSerializable";
            _InternalMessageId_InternalMessageId"USRACT_CircularReferenceDetected"] = 44] = "USRACT_CircularReferenceDetected";
            _InternalMessageId_InternalMessageId"USRACT_ClearAuthContextFailed"] = 45] = "USRACT_ClearAuthContextFailed";
            _InternalMessageId_InternalMessageId"USRACT_ExceptionTruncated"] = 46] = "USRACT_ExceptionTruncated";
            _InternalMessageId_InternalMessageId"USRACT_IllegalCharsInName"] = 47] = "USRACT_IllegalCharsInName";
            _InternalMessageId_InternalMessageId"USRACT_ItemNotInArray"] = 48] = "USRACT_ItemNotInArray";
            _InternalMessageId_InternalMessageId"USRACT_MaxAjaxPerPVExceeded"] = 49] = "USRACT_MaxAjaxPerPVExceeded";
            _InternalMessageId_InternalMessageId"USRACT_MessageTruncated"] = 50] = "USRACT_MessageTruncated";
            _InternalMessageId_InternalMessageId"USRACT_NameTooLong"] = 51] = "USRACT_NameTooLong";
            _InternalMessageId_InternalMessageId"USRACT_SampleRateOutOfRange"] = 52] = "USRACT_SampleRateOutOfRange";
            _InternalMessageId_InternalMessageId"USRACT_SetAuthContextFailed"] = 53] = "USRACT_SetAuthContextFailed";
            _InternalMessageId_InternalMessageId"USRACT_SetAuthContextFailedAccountName"] = 54] = "USRACT_SetAuthContextFailedAccountName";
            _InternalMessageId_InternalMessageId"USRACT_StringValueTooLong"] = 55] = "USRACT_StringValueTooLong";
            _InternalMessageId_InternalMessageId"USRACT_StartCalledMoreThanOnce"] = 56] = "USRACT_StartCalledMoreThanOnce";
            _InternalMessageId_InternalMessageId"USRACT_StopCalledWithoutStart"] = 57] = "USRACT_StopCalledWithoutStart";
            _InternalMessageId_InternalMessageId"USRACT_TelemetryInitializerFailed"] = 58] = "USRACT_TelemetryInitializerFailed";
            _InternalMessageId_InternalMessageId"USRACT_TrackArgumentsNotSpecified"] = 59] = "USRACT_TrackArgumentsNotSpecified";
            _InternalMessageId_InternalMessageId"USRACT_UrlTooLong"] = 60] = "USRACT_UrlTooLong";
        ...
        var _InternalLogMessage = (function () {
            function _InternalLogMessage(msgId, msg, properties) {
                this.message = _InternalMessageIdmsgId].toString();
        ...
        var _InternalLogging = (function () {
            ...
            _InternalLogging.clearInternalMessageLoggedTypes = function () {
                if (ApplicationInsights.Util.canUseSessionStorage()) {
                    ...
                    for (var i = 0; i < sessionStorageKeys.length; i++) {
                        if (sessionStorageKeysi].indexOf(_InternalLogging.AIInternalMessagePrefix) === 0) {
                            ApplicationInsights.Util.removeSessionStorage(sessionStorageKeysi]);
                        }
                    }
                }
            };
            ...
            _InternalLogging.logInternalMessage = function (severity, message) {
                ...
                var logMessage = true;
                if (ApplicationInsights.Util.canUseSessionStorage()) {
                    var storageMessageKey = _InternalLogging.AIInternalMessagePrefix + _InternalMessageIdmessage.messageId];
...
(function (Microsoft) {
    ...
    (function (ApplicationInsights) {
        ...
        (function (StorageType) {
            StorageTypeStorageType"LocalStorage"] = 0] = "LocalStorage";
            StorageTypeStorageType"SessionStorage"] = 1] = "SessionStorage";
                ...
                if (name && name.length) {
                    ...
                    for (var i = 0; i < cookies.length; i++) {
                        ...
                        if (cookie && cookie.indexOf(cookieName) === 0) {
                            value = cookie.substring(cookieName.length, cookiesi].length);
                            break;
                        }
                    }
                }
        ...
        var AjaxMonitor = (function () {
            ...
            AjaxMonitor.prototype.isMonitoredInstance = function (xhr, excludeAjaxDataValidation) {
                return this.initialized
                    ...
                    && xhrAjaxMonitor.DisabledPropertyName] !== true;
            };
...
(function (Microsoft) {
    ...
    (function (ApplicationInsights) {
        "use strict";
        (function (FieldType) {
            FieldTypeFieldType"Default"] = 0] = "Default";
            FieldTypeFieldType"Required"] = 1] = "Required";
            FieldTypeFieldType"Array"] = 2] = "Array";
            FieldTypeFieldType"Hidden"] = 4] = "Hidden";
        ...
        var Serializer = (function () {
            ...
            Serializer._serializeObject = function (source, name) {
                ...
                if (sourcecircularReferenceCheck]) {
                ...
                sourcecircularReferenceCheck] = true;
                for (var field in source.aiDataContract) {
                    var contract = source.aiDataContractfield];
                    ...
                    var isPresent = sourcefield] !== undefined;
                    var isObject = typeof sourcefield] === "object" && sourcefield] !== null;
                    ...
                    if (isObject) {
                        if (isArray) {
                            value = Serializer._serializeArray(sourcefield], field);
                        }
                        else {
                            value = Serializer._serializeObject(sourcefield], field);
                        }
                    }
                    else {
                        value = sourcefield];
                ...
                delete sourcecircularReferenceCheck];
                return output;
            };
                    ...
                    for (var field in map) {
                        ...
                        if (expectedType === "string") {
                            if (value === undefined) {
                                ...
                                outputfield] = "invalid field: toString() is not defined.";
                            }
                            else {
                                outputfield] = value.toString();
                            }
                        }
                            ...
                            outputfield] = "invalid field: " + name + " is of unknown type.";
                            ApplicationInsights._InternalLogging.throwInternalUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, outputfield]);
                        }
                    }
                }
                return output;
...
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) dp] = bp];
    ...
    (function (ApplicationInsights) {
        var SamplingScoreGenerator = (function () {
            ...
            SamplingScoreGenerator.prototype.getSamplingScore = function (envelope) {
                ...
                var score = 0;
                if (envelope.tagstagKeys.userId]) {
                    score = this.hashCodeGeneragor.getHashCodeScore(envelope.tagstagKeys.userId]);
                }
                else if (envelope.tagstagKeys.operationId]) {
                    score = this.hashCodeGeneragor.getHashCodeScore(envelope.tagstagKeys.operationId]);
                }
                else {
                    score = Math.random();
                }
...
(function (AI) {
    ...
    (function (SessionState) {
        SessionStateSessionState"Start"] = 0] = "Start";
        SessionStateSessionState"End"] = 1] = "End";
        ...
        (function (Context) {
            ...
            var _SessionManager = (function () {
                ...
                _SessionManager.prototype.initializeAutomaticSessionWithData = function (sessionData) {
                    ...
                    if (params.length > 0) {
                        this.automaticSession.id = params0];
                    }
                    try {
                        if (params.length > 1) {
                            var acq = +params1];
            ...
            var User = (function () {
                function User(config) {
                    ...
                    if (authCookie) {
                        ...
                        if (authCookieString0]) {
                            this.authenticatedId = authCookieString0];
                        }
                        if (authCookieString.length > 1 && authCookieString1]) {
                            this.accountId = authCookieString1];
                        }
                    }
                }
            ...
            SessionStorageSendBuffer.prototype.removePayloadsFromBuffer = function (payloads, buffer) {
                ...
                for (var i in buffer) {
                    ...
                    for (var j in payloads) {
                        if (payloadsj] === bufferi]) {
                            contains = true;
                            break;
                        }
                    }
                    if (!contains) {
                        remaining.push(bufferi]);
                    }
                }
                ;
                return remaining;
    ...
    (function (ApplicationInsights) {
        ...
        var Sender = (function () {
            ...
            Sender.prototype._xhrSender = function (payload, isAsync) {
                ...
                xhrApplicationInsights.AjaxMonitor.DisabledPropertyName] = true;
...
(function (AI) {
    ...
    (function (SeverityLevel) {
        SeverityLevelSeverityLevel"Verbose"] = 0] = "Verbose";
        SeverityLevelSeverityLevel"Information"] = 1] = "Information";
        SeverityLevelSeverityLevel"Warning"] = 2] = "Warning";
        SeverityLevelSeverityLevel"Error"] = 3] = "Error";
        SeverityLevelSeverityLevel"Critical"] = 4] = "Critical";
                ...
                var DataSanitizer = (function () {
                    ...
                    DataSanitizer.sanitizeKeyAndAddUniqueness = function (key, map) {
                        ...
                        if (field.length !== origLength) {
                            ...
                            while (mapuniqueField] !== undefined) {
                                i++;
                    ...
                    DataSanitizer.sanitizeProperties = function (properties) {
                        if (properties) {
                            ...
                            for (var prop in properties) {
                                var value = DataSanitizer.sanitizeString(propertiesprop]);
                    ...
                    if (typeof stack === "string") {
                        ...
                        for (var i = 0; i <= frames.length; i++) {
                            ...
                            if (_StackFrame.regex.test(frame)) {
                                var parsedFrame = new _StackFrame(framesi], level++);
                        ...
                        if (totalSizeInBytes > exceptionParsedStackThreshold) {
                            ...
                            while (left < right) {
                                var lSize = parsedStackleft].sizeInBytes;
                                var rSize = parsedStackright].sizeInBytes;
                                size += lSize + rSize;
            ...
            var _StackFrame = (function (_super) {
                ...
                function _StackFrame(frame, level) {
                    ...
                    if (matches && matches.length >= 5) {
                        this.method = ApplicationInsights.Util.trim(matches2]) || this.method;
                        this.fileName = ApplicationInsights.Util.trim(matches4]);
                        this.line = parseInt(matches5]) || 0;
                    }
...
(function (AI) {
    ...
    (function (DataPointType) {
        DataPointTypeDataPointType"Measurement"] = 0] = "Measurement";
        DataPointTypeDataPointType"Aggregation"] = 1] = "Aggregation";
            ...
            TelemetryContext.prototype._track = function (envelope) {
                ...
                try {
                    ...
                    for (var i = 0; i < telemetryInitializersCount; ++i) {
                        var telemetryInitializer = this.telemetryInitializersi];
            ...
            TelemetryContext.prototype._applyApplicationContext = function (envelope, appContext) {
                if (appContext) {
                    ...
                    if (typeof appContext.ver === "string") {
                        envelope.tagstagKeys.applicationVersion] = appContext.ver;
                    }
                    if (typeof appContext.build === "string") {
                        envelope.tagstagKeys.applicationBuild] = appContext.build;
                    }
                }
            };
            TelemetryContext.prototype._applyDeviceContext = function (envelope, deviceContext) {
                ...
                if (deviceContext) {
                    if (typeof deviceContext.id === "string") {
                        envelope.tagstagKeys.deviceId] = deviceContext.id;
                    }
                    if (typeof deviceContext.ip === "string") {
                        envelope.tagstagKeys.deviceIp] = deviceContext.ip;
                    }
                    if (typeof deviceContext.language === "string") {
                        envelope.tagstagKeys.deviceLanguage] = deviceContext.language;
                    }
                    if (typeof deviceContext.locale === "string") {
                        envelope.tagstagKeys.deviceLocale] = deviceContext.locale;
                    }
                    if (typeof deviceContext.model === "string") {
                        envelope.tagstagKeys.deviceModel] = deviceContext.model;
                    }
                    if (typeof deviceContext.network !== "undefined") {
                        envelope.tagstagKeys.deviceNetwork] = deviceContext.network;
                    }
                    if (typeof deviceContext.oemName === "string") {
                        envelope.tagstagKeys.deviceOEMName] = deviceContext.oemName;
                    }
                    if (typeof deviceContext.os === "string") {
                        envelope.tagstagKeys.deviceOS] = deviceContext.os;
                    }
                    if (typeof deviceContext.osversion === "string") {
                        envelope.tagstagKeys.deviceOSVersion] = deviceContext.osversion;
                    }
                    if (typeof deviceContext.resolution === "string") {
                        envelope.tagstagKeys.deviceScreenResolution] = deviceContext.resolution;
                    }
                    if (typeof deviceContext.type === "string") {
                        envelope.tagstagKeys.deviceType] = deviceContext.type;
                    }
                }
            };
            TelemetryContext.prototype._applyInternalContext = function (envelope, internalContext) {
                if (internalContext) {
                    ...
                    if (typeof internalContext.agentVersion === "string") {
                        envelope.tagstagKeys.internalAgentVersion] = internalContext.agentVersion;
                    }
                    if (typeof internalContext.sdkVersion === "string") {
                        envelope.tagstagKeys.internalSdkVersion] = internalContext.sdkVersion;
                    }
                }
            };
            TelemetryContext.prototype._applyLocationContext = function (envelope, locationContext) {
                if (locationContext) {
                    ...
                    if (typeof locationContext.ip === "string") {
                        envelope.tagstagKeys.locationIp] = locationContext.ip;
                    }
                }
            };
            TelemetryContext.prototype._applyOperationContext = function (envelope, operationContext) {
                if (operationContext) {
                    ...
                    if (typeof operationContext.id === "string") {
                        envelope.tagstagKeys.operationId] = operationContext.id;
                    }
                    if (typeof operationContext.name === "string") {
                        envelope.tagstagKeys.operationName] = operationContext.name;
                    }
                    if (typeof operationContext.parentId === "string") {
                        envelope.tagstagKeys.operationParentId] = operationContext.parentId;
                    }
                    if (typeof operationContext.rootId === "string") {
                        envelope.tagstagKeys.operationRootId] = operationContext.rootId;
                    }
                    if (typeof operationContext.syntheticSource === "string") {
                        envelope.tagstagKeys.operationSyntheticSource] = operationContext.syntheticSource;
                    }
                }
            };
            ...
            TelemetryContext.prototype._applySessionContext = function (envelope, sessionContext) {
                if (sessionContext) {
                    ...
                    if (typeof sessionContext.id === "string") {
                        envelope.tagstagKeys.sessionId] = sessionContext.id;
                    }
                    if (typeof sessionContext.isFirst !== "undefined") {
                        envelope.tagstagKeys.sessionIsFirst] = sessionContext.isFirst;
                    }
                }
            };
            TelemetryContext.prototype._applyUserContext = function (envelope, userContext) {
                if (userContext) {
                    ...
                    if (typeof userContext.accountId === "string") {
                        envelope.tagstagKeys.userAccountId] = userContext.accountId;
                    }
                    if (typeof userContext.agent === "string") {
                        envelope.tagstagKeys.userAgent] = userContext.agent;
                    }
                    if (typeof userContext.id === "string") {
                        envelope.tagstagKeys.userId] = userContext.id;
                    }
                    if (typeof userContext.authenticatedId === "string") {
                        envelope.tagstagKeys.userAuthUserId] = userContext.authenticatedId;
                    }
                    if (typeof userContext.storeRegion === "string") {
                        envelope.tagstagKeys.userStoreRegion] = userContext.storeRegion;
                    }
                }
            };
...
(function (AI) {
    ...
    (function (DependencyKind) {
        DependencyKindDependencyKind"SQL"] = 0] = "SQL";
        DependencyKindDependencyKind"Http"] = 1] = "Http";
        DependencyKindDependencyKind"Other"] = 2] = "Other";
...
(function (AI) {
    ...
    (function (DependencySourceType) {
        DependencySourceTypeDependencySourceType"Undefined"] = 0] = "Undefined";
        DependencySourceTypeDependencySourceType"Aic"] = 1] = "Aic";
        DependencySourceTypeDependencySourceType"Apmc"] = 2] = "Apmc";
    ...
    (function (ApplicationInsights) {
                ...
                if (defaults !== undefined) {
                    for (var field in defaults) {
                        if (this.configfield] === undefined) {
                            this.configfield] = defaultsfield];
                        }
                    }
                }
        ...
        var Timing = (function () {
            ...
            Timing.prototype.stop = function (name, url, properties, measurements) {
                ...
                delete this._eventsname];
                this._eventsname] = undefined;
            };
            return Timing;
        })();
    })(ApplicationInsights = Microsoft.ApplicationInsights || (Microsoft.ApplicationInsights = {}));
    ...
    (function (ApplicationInsights) {
        ...
        var Initialization = (function () {
            ...
            Initialization.prototype.loadAppInsights = function () {
                ...
                if (typeof this.snippetlegacyPageView] === "function") {
                    appInsightslegacyPageView] = function (pagePath, properties, measurements) {
                        appInsights.trackPageView(null, pagePath, properties, measurements);
                    };
                }
                var legacyEvent = "logEvent";
                if (typeof this.snippetlegacyEvent] === "function") {
                    appInsightslegacyEvent] = function (name, properties, measurements) {
            ...
            Initialization.prototype.pollInteralLogs = function (appInsightsInstance) {
                return setInterval(function () {
                    ...
                    for (var i = 0; i < length; i++) {
                        appInsightsInstance.trackTrace(queuei].message);
                    }
                    queue.length = 0;
...
(function (AI) {
    "use strict";
    (function (TestResult) {
        TestResultTestResult"Pass"] = 0] = "Pass";
        TestResultTestResult"Fail"] = 1] = "Fail";
